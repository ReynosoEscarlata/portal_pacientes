...
- [x] 01-01-PLAN.md — Fix CURP_REGEX position-17/18 tail and add post-2000 + invalid-variant regression tests (CURP-01, CURP-02)
...
- [x] 02-02-PLAN.md — Sync phases.config.json curp.pattern to backend regex, reusable renderConWizard harness, and PhaseRenderer pattern-validation component test (CURP-05, CURP-06)
